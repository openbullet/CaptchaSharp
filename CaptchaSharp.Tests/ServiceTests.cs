...
public class ServiceTests
{
    ...
    private readonly string _captchaImageBase64 =
    ...
    protected Task RecaptchaV2InvisibleTest_WithProxy() => RecaptchaV2InvisibleTest(fixture.Config.Proxy);
    ...
    protected Task RecaptchaV2EnterpriseTest_WithProxy() => RecaptchaV2EnterpriseTest(fixture.Config.Proxy);
    ...
    protected Task RecaptchaV3EnterpriseTest_WithProxy() => RecaptchaV3EnterpriseTest(fixture.Config.Proxy);
